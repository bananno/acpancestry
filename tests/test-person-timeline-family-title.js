...
test(t => {
  ...
  personRootTemplate.siblings = [personSibling1Template._id, personSibling2Template._id];
  ...
  (() => {
    ...
    timelineItem = new PersonTimelineItem(timelineEvent, true, personRoot);
  ...
  (() => {
    ...
    timelineEvent.people = [personMother];
    timelineItem = new PersonTimelineItem(timelineEvent, true, true);
